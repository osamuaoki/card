...
%  rendered, see below.
%
\newcommand{\xname}{Osamu Aoki, Ph.D.}
\newcommand{\xtitle}{Debian GNU/Linux Developer}
\newcommand{\xproject}{Debian Documentation Project}
\newcommand{\xaddress}{Yokohama, Japan}
\newcommand{\xemail}{osamu@debian.org}
\newcommand{\xurl}{http://www.debian.org/\~{}osamu/}
%
...
\newcommand{\xkeyid}{RSA4096}
\newcommand{\xfprintA}{3133 724D 6207 8815 79E9}
\newcommand{\xfprintB}{5D62 1E13 5688 1DD8 D791}
...
\begin{picture}(178,253)(-7,-1)
  ...
  \multiput(0,0)(0,51.0){5}{%
	...
	%
        ...
        \put(35,38){\textsc{\scriptsize\xtitle}}
        \put(35,34){\textsc{\scriptsize\xproject}}

        \put(35,28){\textsf{\scriptsize \xemail}}
        \put(35,24){\textsf{\scriptsize \xurl}}
        \put(35,20){\scriptsize \xaddress}
	...
	% 2 Line GPG key
        \put(6,9){\texttt {\scriptsize \xkeyid:}}
	\put(22,8){\texttt {\large \xfprintA}}
        \put(22,4){\texttt {\large \xfprintB}}
	% For one key [1.2x]
